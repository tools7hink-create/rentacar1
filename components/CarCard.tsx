...
const CarCard: React.FC<CarCardProps> = ({ car }) => {
  ...
  return (
    <div className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 border border-slate-100 flex flex-col h-full">
      <div className="relative h-64 overflow-hidden">
        ...
        />
        <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider text-slate-800 shadow-sm">
          {car.category}
        </div>
      </div>
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="grid grid-cols-3 gap-2 mb-6 text-sm text-slate-600">
          ...
          <div className="flex flex-col items-center bg-slate-50 p-2 rounded-lg">
            ...
            {/* Fixed: Access seats from specs object */}
        ...
        <div className="mt-auto flex items-center justify-between border-t border-slate-100 pt-4">
          ...
          <Button 
            ...
            className="group-hover:bg-luxury-black group-hover:text-white group-hover:border-luxury-black transition-colors"
          >
